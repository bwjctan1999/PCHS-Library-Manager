...
Public Class Form_Add_Edit_Book
    ...
    '  1. FORM LOADER  
    '==================
    Private Sub Form_Add_Edit_Book_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        PopulateSubjects
    End Sub
            ...
            Else
                Try
                    ...
                    If Msg.ShowDialog() = DialogResult.OK Then
                        command("INSERT INTO tbl_authors (`author_name`) VALUES ('" & Txtbox_Author.Text & "'); Select @@identity")
        ...
        Try
            ...
            Else
                ...
                If Msg.ShowDialog() = DialogResult.OK Then
                    ...
                    command("INSERT INTO tbl_publishers (`pub_name`) VALUES ('" & Txtbox_Publisher.Text & "'); SELECT @@identity")
    ...
    Private Sub FillTextboxes()
        ...
        command("SELECT * FROM tbl_book 
                    ...
                    INNER JOIN tbl_publishers ON tbl_publishers.publisherID = tbl_book.publisherID 
                    WHERE (bookID = @bookid)")
        ...
        While reader.Read()
            Txtbox_Title.Text = reader("title")
            Txtbox_Author.Text = reader("author_name")
            Txtbox_ISBNNo.Text = reader("isbn")
            DatePicker.Value = reader("yearPublished")
            Txtbox_Quantity.Text = reader("quantity")
            Txtbox_ShelfNo.Text = reader("shelfNo")
            Txtbox_Publisher.Text = reader("pub_name")
            ...
            For Each item In Cbox_Subjects.Items
                If reader("sub_name") = Cbox_Subjects.GetItemText(item) Then Cbox_Subjects.SelectedItem = item
            Next
        End While
    ...
    Private Function ErrorChecker()
        ...
        Dim boxname As String() = {"Title", "Author", "ISBN No", "Code No", "Publisher", "Quantity", "Shelf No"}
