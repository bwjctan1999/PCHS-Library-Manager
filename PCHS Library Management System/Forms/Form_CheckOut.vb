...
Public Class Form_CheckOut
    ...
    Private Sub Btn_Select_Click(sender As Object, e As EventArgs) Handles Btn_Select.Click
        Dim BorrowerForm As New Form_BorrowerList

        If BorrowerForm.ShowDialog = DialogResult.OK Then
            Txtbox_ID.Text = BorrowerForm.selectedID
            Lbl_Name.Text = BorrowerForm.selectedname
        End If
    End Sub
End Class